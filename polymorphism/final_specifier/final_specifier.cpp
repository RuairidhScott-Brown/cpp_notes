...
FINAL SPECIFIER C++11
    - prevents a class being derived from at the class level
    - prevents virtual methods from eing overridden in derived classes, this is at the method level.

//AT THE CLASS LEVEL

class My_Class final {};
class Derived final: publcic Base {};
*/
